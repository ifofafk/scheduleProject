...
public class DesCryptUtil {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String word = base64Encoder.encode(md5.digest("123456".getBytes("utf-8")));
			System.out.println(word);
			System.out.println(md5.digest("123456".getBytes("utf-8")));
		} catch (Exception e) {
			e.printStackTrace();
		}
//		try {
//			String test = "/search/archive_vehicleIndex.action@archiveId=2$hphm=粤A66666$hpzl=小型汽车@123321";
////
////			//DesCryptUtil des = new DesCryptUtil("20*Ab#!z");// 自定义密钥
//			DesCryptUtil des = new DesCryptUtil("sungoalLoginGrant");
//			System.out.println("加密前的字符：" + test);
//			System.out.println("加密后的字符：" + des.encrypt(test));
//			System.out.println("解密后的字符1：" + des.decrypt(des.encrypt(test)));
//			System.out.println("解密后的字符2：" + des.decrypt(test));
//
